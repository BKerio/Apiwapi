 ...
 * auto-join of a personal room and a role room so the campaigns module can
 * push live send progress (`campaign:progress`) to connected operators
 * without a poll loop on the frontend.
 */
